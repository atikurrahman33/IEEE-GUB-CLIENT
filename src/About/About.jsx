...
const About = () => {
    return (
        <section className="text-gray-700">
            {/* Section Header */}
            <div className="text-center py-16 px-6 md:px-24 ">
                <h2 className="text-4xl font-bold text-blue-900 mb-4">Get to Know IEEE</h2>
            ...
            {/* Who We Are Section */}
            <div className="flex flex-col md:flex-row items-center px-6 md:px-24 py-12 gap-12">
                <motion.img
            ...
            <div className="px-6 md:px-24 py-16 ">
                ...
                <div className="flex overflow-x-auto gap-6 py-4 no-scrollbar">
                    {[
                        ...
                        <motion.div
                            key={idx}
                            className="min-w-[260px] bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300 text-center"
